...
date=2011-07-06
tags=java, snippets
slug=collection-of-useful-java-code-snippets
summary=Growing list of useful and interesting java code snippets
category=Java
...
If you have Java agents, those agents can have a premain method which is called first. [Instrument package][1]
