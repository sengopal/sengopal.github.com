<head>
  ...
  <link rel="shortcut icon" href="<#if (content.rootpath)??>${content.rootpath}<#else></#if>favicon.ico" type="image/x-icon">
  <link rel="icon" href="<#if (content.rootpath)??>${content.rootpath}<#else></#if>favicon.ico" type="image/x-icon">
  <script>
